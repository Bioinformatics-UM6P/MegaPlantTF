...
def main():
    ...
    parser.add_argument("--output", type=str, default=None,
                        help="Path to output HTML file. Default: saved under ./output/ folder.")
    ...
    if args.output is None:
        args.output = os.path.join(output_dir, f"MegaPlantTF_Report_{args.jobid}.html")
    ...
    print(f"Report name    : {os.path.basename(args.output)}")
    print("--------------------------------------------------")
    ...
    html_report = build_html_report(genboard, args.voting, args.threshold, args.jobid)
